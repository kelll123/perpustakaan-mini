...
@section('content')
    <div class="container-fluid px-4">
        ...
        <h1 class="mt-4 mb-4">Manajemen Data Buku (Staff Area)</h1>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header py-3 bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <form action="{{ route('staff.books.index') }}" method="GET" class="d-flex">
                    ...
                    <a href="{{ route('staff.books.create') }}" class="btn btn-success text-nowrap">
