            ...
            <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="stock" value="{{ old('stock', $book->stock) }}" min="0" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_author" value="{{ old('nama_author', $book->author->nama_author ?? '') }}" required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="id_category" required>
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ $book->id_category == $category->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    @if($book->cover)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $book->cover) }}" alt="Cover Saat Ini" width="100" class="img-thumbnail">
